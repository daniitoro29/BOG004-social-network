...
export const savePost = (post, userName, date) =>
  addDoc(collection(db, "posts"), { post, userName, date, like: [] });
...
/* const unsubscribe = await onSnapshot(q, async (querySnapshot) => {
  ...
  console.log("Current post in CA: ", post.join(", "));
}); */
return q;
}
...
export const deletePost = async (id, posts) =>
